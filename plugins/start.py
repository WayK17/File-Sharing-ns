...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        k = await client.send_message(chat_id = message.from_user.id, text=f"<b>❗️ <u>IMPORTANTE</u> ❗️</b> \n\nEste video / archivo se eliminará en {file_auto_delete} (debido a problemas de derechos de autor).\n\n📌 Por favor, reenvíe este video / archivo a otro lugar y comience a descargarlo allí.")
        ...
        # for madflix_msg in madflix_msgs: 
            # try:
                ...
                # await k.edit_text("Su video / archivo se ha eliminado ✅ con éxito") 
            # except:    
                # pass 
...
async def delete_files(messages, client, k):
    ...
    # await client.send_message(messages[0].chat.id, "Su video / archivo se ha eliminado ✅ con éxito")
    await k.edit_text("Su video / archivo se ha eliminado ✅ con éxito")
